                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            {{ 'Votre commande a été confirmé.' }} <br>
                                            {{ $order->traitor_note ?? '' }}
                                            {{ 'Veuillez marquer lorsque votre commande vous sera livré.' }} <br>
                                            @elseif ($order->status === 'denied')
                                            {{ 'Votre commande a malheureusement été refusé' }} <br>
                                            {{ $order->traitor_note ?? '' }}
                                            @endif
                                        </p>
                                        @if ($order->status === 'allowed')
                                                                        ...
                                                                        <tr>
                                                                            <td target="_blank" rel="noopener"
                                                                                ...
                                                                                <a class="button button-primary"
                                                                                    ...
                                                                                    href="">Accéder à l'application</a>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
