                ...
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between">
                        <h1 class="font-bold text-lg my-2">
                            Liste des traiteurs
                            @if (request()->routeIs('admin.traitors.allowed'))
                                autorisés
                            @elseif (request()->routeIs('admin.traitors.denied'))
                                refusées
                            @elseif (request()->routeIs('admin.traitors.index'))
                                en attentes
                            @endif
                        </h1>
                    </div>
                    ...
                    <div class="mt-4">
                        <x-table :resources="$traitors" :mattributes="$my_attributes" type="admin.traitor" :mactions="$my_actions" />
                    </div>
                </div>
            </div>
        </div>
