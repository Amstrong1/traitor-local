        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <nav>
                <ol class="flex items-center gap-2">
                    ...
                    <li class="font-medium text-primary">Informations du traiteur</li>
                </ol>
            </nav>
        </div>
        <!-- Breadcrumb End -->
            ...
            <div class="flex flex-col gap-9">
                ...
                <div
                    ...
                    <div class="p-6 border-b border-stroke dark:border-strokedark">
                        <form action="{{ route('admin.traitors.allow', [$traitor->id]) }}" method="POST">
                            @csrf
                            <div class="mb-6">
                                <label class="mb-3 block text-black">
                                    Message
                    ...
                    <div class="p-6">
                        <form action="{{ route('admin.traitors.deny', [$traitor->id]) }}" method="POST">
                            @csrf
                            <div class="mb-6">
                                <label class="mb-3 block text-black">
                                    Message
