...
<body class="font-sans text-gray-900 antialiased">
    ...
    <div class="" style="background-color: #bdd5f8">
        <div class="">
            <!--Main-->
            <div class="container px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
    ...
    <div id="testimonies" class="p-4 flex items-center justify-center h-96 bg-fixed bg-center bg-cover brightness-100"
        style="background-image:url('img/parallax.jpg')">
        <!--Carousel-->
        <div class="absolute w-full h-96" style="background: rgba(17, 22, 24, .5)"></div>
