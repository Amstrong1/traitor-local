<x-user-app>
    ...
    <form method="POST" action="{{ route('login') }}" class="m-4">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="email" class="block mt-1 w-full border-2 py-4" type="email" name="email" :value="old('email')" required
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" class="block mt-1 w-full border-2 py-4" type="password" name="password" required
