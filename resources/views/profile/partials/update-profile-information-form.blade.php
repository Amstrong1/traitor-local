<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="name" name="name" max="50" type="text" class="mt-1 block w-full" :value="old('name', $user->name)" required autofocus autocomplete="name" />
        ...
        <div>
            ...
            <x-text-input id="postal" name="postal" max="5" type="text" class="mt-1 block w-full" :value="old('postal', $user->postal)" required autofocus autocomplete="name" />
