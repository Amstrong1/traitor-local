...
<nav id="menu"
    class="bg-black opacity-80 text-white rounded-tr-xl fixed left-0 top-16 mt-8 z-[1035] h-full w-60 -translate-x-full overflow-hidden shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)] data-[te-sidenav-hidden='true']:translate-x-0 dark:bg-zinc-800"
...
<!-- Sidenav left (cart)-->
<nav id="cart"
    class="bg-black opacity-90 text-white rounded-tl-xl fixed right-0 top-16 mt-8 z-[1035] h-full w-60 translate-x-full overflow-hidden shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)] data-[te-sidenav-hidden='true']:-translate-x-0 dark:bg-zinc-800 overflow-x-auto pb-16"
